...
namespace Listenarr.Tests.Features.Api.Services
{
    public class downloadImportServiceHardlinkTests : BaseTests
    {
        ...
        public async Task ImportFilesFromDirectory_UsesHardlink_WhenModeIsHardlinkCopy()
        {
            ...
            // Act
            var results = await downloadImportService.ImportFilesFromDirectoryAsync(_download, _audiobook, [file1], _settings);
        ...
        public async Task ImportFilesFromDirectory_HandlesMultipleFiles_WithHardlinkCopy()
        {
            ...
            // Act
            var results = await downloadImportService.ImportFilesFromDirectoryAsync(_download, _audiobook, [file1, file2, file3], _settings);
