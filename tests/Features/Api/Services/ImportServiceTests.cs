...
namespace Listenarr.Tests.Features.Api.Services
{
    public class downloadImportServiceTests : BaseTests
    {
        ...
        public async Task ImportFilesFromDirectory_CreatesDestinationDirectory_WhenMissing()
        {
            ...
            var results = await downloadImportService.ImportFilesFromDirectoryAsync(_download, _audiobook, [file1, file2], _settings);
        ...
        public async Task ImportSingleFile_WithAudiobookBasePath_DoesNotDuplicateFolderPatternSegments()
        {
            ...
            var result = await downloadImportService.ImportSingleFileAsync(_download, _audiobook, sourceFile, _settings);
        ...
        public async Task ImportFilesFromDirectory_ForewordAndChapterOne_GetStableUniqueSequenceNames()
        {
            ...
            var downloadImportService = _provider.GetRequiredService<IDownloadImportService>();
            var results = await downloadImportService.ImportFilesFromDirectoryAsync(download, audiobook, [foreword, chapter1, chapter2], settings);
        ...
        public async Task ImportFilesFromDirectory_MoveImportsCompanionFilesAndDeletesSourceFolder()
        {
            ...
            var downloadImportService = _provider.GetRequiredService<IDownloadImportService>();
            var results = await downloadImportService.ImportFilesFromDirectoryAsync(download, audiobook, [audioFile, coverFile, notesFile], settings);
        ...
        public async Task ImportFilesFromDirectory_NestedTorrentFolders_DoNotDuplicateSeriesAndTitleSegments()
        {
            ...
            var downloadImportService = _provider.GetRequiredService<IDownloadImportService>();
            var results = await downloadImportService.ImportFilesFromDirectoryAsync(download, audiobook, [sourceFile], settings);
        ...
        public async Task ImportSingleFile_WithWindowsShortBasePath_NormalizesFinalPath()
        {
            ...
            var result = await downloadImportService.ImportSingleFileAsync(_download, audiobook, sourceFile, settings);
        ...
        public async Task ImportFilesFromDirectory_WithAudiobookMetadata_SupportsEditionSubtitlePublisherLanguageAndAsinTokens()
        {
            ...
            var downloadImportService = _provider.GetRequiredService<IDownloadImportService>();
            var results = await downloadImportService.ImportFilesFromDirectoryAsync(_download, audiobook, [firstSourceFile, secondSourceFile], settings);
